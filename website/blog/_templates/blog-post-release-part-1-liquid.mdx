...
download_url: https://github.com/xpack-dev-tools/qemu-riscv-xpack/releases/tag/v{{xpackVersion}}/
...
```console
$ .../xpack-qemu-riscv-{{xpackVersion}}/bin/qemu-system-riscv32 -machine help
...
$ .../xpack-qemu-riscv-{{xpackVersion}}/bin/qemu-system-riscv32 -cpu help
any
lowrisc-ibex
max
rv32
...
$ .../xpack-qemu-riscv-{{xpackVersion}}/bin/qemu-system-riscv64 -machine help
Supported machines are:
...
spike                RISC-V Spike board (default)
virt                 RISC-V VirtIO board
$ .../xpack-qemu-riscv-{{xpackVersion}}/bin/qemu-system-riscv64 -cpu help
any
max
rv64
shakti-c
