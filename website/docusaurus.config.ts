...
const config: Config = {
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/xpack-dev-tools/qemu-riscv-xpack/edit/xpack/website/',
        ...
        sitemap: {
          ...
          priority: 0.5,
          ignorePatterns: [
            '/qemu-riscv-xpack/blog/archive/**',
            '/qemu-riscv-xpack/blog/authors/**',
            '/qemu-riscv-xpack/blog/tags/**'
          ],
  ...
  headTags: [
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/png',
        href: '/qemu-riscv-xpack/favicons/favicon-48x48.png',
        sizes: '48x48'
      }
    },
    {
      ...
      attributes: {
        rel: 'icon',
        type: 'image/svg+xml',
        href: '/qemu-riscv-xpack/favicons/favicon.svg'
      }
    },
    {
      tagName: 'link',
      attributes: {
        rel: 'shortcut icon',
        href: '/qemu-riscv-xpack/favicons/favicon.ico'
      }
    },
    {
    ...
    },
    {
      ...
      attributes: {
        rel: 'manifest',
        href: '/qemu-riscv-xpack/favicons/site.webmanifest'
      }
    }
  ],
  ...
  themeConfig: {
    ...
    metadata: [
      {
        name: 'keywords',
        content: 'xpack, binary, development, tools, reproducibility, qemu-riscv'
      }
    ],
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/xpack-dev-tools/qemu-riscv-xpack/',
          position: 'right',
        ...
        },
        {
          ...
          position: 'right',
          href: `https://github.com/xpack-dev-tools/qemu-riscv-xpack/releases/tag/v${customFields.xpackVersion}`,
        },
      ],
    },
    footer: {
          ...
          items: [
            {
              ...
              href: 'https://github.com/xpack-dev-tools/qemu-riscv-xpack/discussions',
            },
            {
