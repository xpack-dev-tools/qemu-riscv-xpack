...
title: Getting Started with xPack QEMU RISC-V
...
**xPack QEMU RISC-V** is a standalone
cross-platform (Windows, macOS, GNU/Linux)binary distribution of QEMU RISC-V,
intended for reproducible builds.

<Overview/>

The open source **xPack QEMU RISC-V** project is hosted on GitHub as
...
[release assets](https://github.com/xpack-dev-tools/qemu-riscv-xpack/releases).

In addition to the binary archives and the package metadata,
this project also includes the
[build scripts](https://github.com/xpack-dev-tools/qemu-riscv-xpack/tree/xpack/build-assets/scripts).
...
The main advantages of using the **xPack QEMU RISC-V** are:
...
[GitHub Discussions](https://github.com/xpack-dev-tools/qemu-riscv-xpack/discussions/).
...
[`qemu-riscv-xpack.git/build-assets/scripts`](https://github.com/xpack-dev-tools/qemu-riscv-xpack/tree/xpack/build-assets/scripts/)
...
- **Star** the project on [GitHub](https://github.com/xpack-dev-tools/qemu-riscv-xpack/): It helps others discover our work.
