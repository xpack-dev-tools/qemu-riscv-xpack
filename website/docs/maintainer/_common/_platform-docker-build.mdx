...
* <code>xpack-qemu-riscv-{customField('upstreamVersion')}-{customField('xpackSubversion')}-{props.platform}.{props.platform === 'win32-x64' ? 'zip' : 'tar.gz'}</code>
* <code>xpack-qemu-riscv-{customField('upstreamVersion')}-{customField('xpackSubversion')}-{props.platform}.{props.platform === 'win32-x64' ? 'zip' : 'tar.gz'}.sha</code>
