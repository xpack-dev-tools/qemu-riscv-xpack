...
```sh
npm run generate-top-commons -C ~/Work/xpack-dev-tools/qemu-riscv-xpack.git
```
...
- open https://xpack-dev-tools.github.io/qemu-riscv-xpack/docs/maintainer/#publish-the-website in a separate window
...
[![NPM Version](https://img.shields.io/npm/v/%40xpack-dev-tools%2Fqemu-riscv?color=green)](https://www.npmjs.com/package/@xpack-dev-tools/qemu-riscv/)
[![NPM Downloads](https://img.shields.io/npm/dm/%40xpack-dev-tools%2Fqemu-riscv)](https://www.npmjs.com/package/@xpack-dev-tools/qemu-riscv/)
  - all releases [![NPM Downloads](https://img.shields.io/npm/dt/%40xpack-dev-tools%2Fqemu-riscv)](https://www.npmjs.com/package/@xpack-dev-tools/qemu-riscv/)
