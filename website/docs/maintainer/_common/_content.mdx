...
(such as **8.2.6-1.1**) with the following expression:
...
tagged such as **v8.2.6-1** (mind the dash in the middle!) and
named such as **xPack QEMU RISC-V v8.2.6-1** (mind the dash),
