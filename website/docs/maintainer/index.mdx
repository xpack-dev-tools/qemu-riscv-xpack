...
title: How to make new xPack QEMU RISC-V releases
...
named like **xPack QEMU RISC-V v{customField('upstreamVersion')}-{customField('xpackSubversion')}** (mind the dash),
...
npm dist-tag add @xpack-dev-tools/qemu-riscv@${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')} latest
npm dist-tag ls @xpack-dev-tools/qemu-riscv
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`npm unpublish @xpack-dev-tools/qemu-riscv@${customField('upstreamVersion')}-${customField('xpackSubversion')}.${customField('npmSubversion')}
`} </CodeBlock>
...
- paste the release name like _**xPack QEMU RISC-V v{customField('upstreamVersion')}-{customField('xpackSubversion')} released**_
