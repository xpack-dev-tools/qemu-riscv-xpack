...
`$ tree -L 2 ~/.local/xPacks/\@xpack-dev-tools/qemu-riscv/${customField('xpackVersion')}/.content/
/home/ilg/.local/xPacks/\@xpack-dev-tools/qemu-riscv/${customField('xpackVersion')}/.content/
├── README.md
├── bin
│   ├── qemu-system-riscv32
│   └── qemu-system-riscv64
