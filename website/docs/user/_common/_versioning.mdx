...
upstream {props.upstreamName ? props.upstreamName : 'QEMU RISC-V'} project
is a three-number string
such as <code>9.2.4</code>;
...
such as <code>9.2.4-<b>1</b></code>. When
published as an npm package, the version receives
a fifth number,
such as <code>9.2.4-1.<b>1</b></code>.

Since adherence of third-party packages to SemVer is not guaranteed,
it is recommended to avoid referencing the xPack QEMU RISC-V dependency via
SemVer expressions
such as <code>^9.2.4-1</code> or <code>~9.2.4-1</code>, and
