...
`C:\> tree /f %USERPROFILE%\\AppData\\Roaming\\xPacks\\@xpack-dev-tools\\qemu-riscv\\${customField('xpackVersion')}\\.content
Folder PATH listing
...
<CodeBlock language="console"> {
`$ tree -L 2 ~/Library/xPacks/\@xpack-dev-tools/qemu-riscv/${customField('xpackVersion')}/.content/
/Users/ilg/Library/xPacks/\@xpack-dev-tools/qemu-riscv/${customField('xpackVersion')}/.content/
├── README.md
├── bin
│   ├── qemu-system-riscv32
│   └── qemu-system-riscv64
