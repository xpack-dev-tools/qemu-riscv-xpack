...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/qemu-riscv@${customField('releaseVersion')} --verbose
`} </CodeBlock>
...
In order to access the QEMU RISC-V binaries installed in
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/\@pack-dev-tools/qemu-riscv/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/\@pack-dev-tools/qemu-riscv/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/qemu-riscv/${customField('xpackVersion')}.${customField('npmSubversion')}/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-qemu-riscv-{customField('xpackVersion')}-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\qemu-riscv\\xpack-qemu-riscv-{customField('xpackVersion')}</code>.
...
<ul>
<li><code>xpack-qemu-riscv-{customField('xpackVersion')}-darwin-x64.tar.gz</code></li>
<li><code>xpack-qemu-riscv-{customField('xpackVersion')}-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/qemu-riscv/xpack-qemu-riscv-{customField('xpackVersion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/qemu-riscv
cd ~/Library/xPacks/qemu-riscv

tar xvf ~/Downloads/xpack-qemu-riscv-${customField('xpackVersion')}-darwin-x64.tar.gz
chmod -R -w xpack-qemu-riscv-${customField('xpackVersion')}
`} </CodeBlock>
...
<ul>
<li><code>xpack-qemu-riscv-{customField('xpackVersion')}-linux-x64.tar.gz</code></li>
<li><code>xpack-qemu-riscv-{customField('xpackVersion')}-linux-arm64.tar.gz</code></li>
<li><code>xpack-qemu-riscv-{customField('xpackVersion')}-linux-arm.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/qemu-riscv/xpack-qemu-riscv-{customField('xpackVersion')}</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/qemu-riscv
cd ~/.local/xPacks/qemu-riscv

tar xvf ~/Downloads/xpack-qemu-riscv-${customField('xpackVersion')}-linux-x64.tar.gz
chmod -R -w xpack-qemu-riscv-${customField('xpackVersion')}
`} </CodeBlock>
