...
title: How to install qemu-riscv
...
# How to install xPack QEMU RISC-V
...
<CodeBlock language="sh"> {
`xpm install @xpack-dev-tools/qemu-riscv@${customField('version')} --verbose
`} </CodeBlock>
...
- <code>xpack-qemu-riscv-{customField('xpackVersion')}-win32-x64.zip</code>
...
- <code>xpack-qemu-riscv-{customField('xpackVersion')}-darwin-x64.tar.gz</code>- <code>xpack-qemu-riscv-{customField('xpackVersion')}-darwin-arm64.tar.gz</code>
...
- <code>xpack-qemu-riscv-{customField('xpackVersion')}-linux-x64.tar.gz</code>- <code>xpack-qemu-riscv-{customField('xpackVersion')}-linux-arm64.tar.gz</code>- <code>xpack-qemu-riscv-{customField('xpackVersion')}-linux-arm.tar.gz</code>
