...
The **xPack QEMU RISC-V** may be installed automatically, utilising the `xpm` command
(the recommended method), or manually, by downloading and unpacking one of the
platform-specific archives.

## Automated installation

The easiest (and recommended) method to install xPack QEMU RISC-V
...
<CodeBlock language="sh"> {
`export PATH=$HOME/AppData/Roaming/xPacks/@xpack-dev-tools/qemu-riscv/9.2.4-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/Library/xPacks/@xpack-dev-tools/qemu-riscv/9.2.4-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<CodeBlock language="sh"> {
`export PATH=$HOME/.local/xPacks/@xpack-dev-tools/qemu-riscv/9.2.4-1.1/.content/bin:$PATH
`} </CodeBlock>
...
<ul>
<li><code>xpack-qemu-riscv-9.2.4-1-win32-x64.zip</code></li>
</ul>
...
example <code>C:\\Users\\ilg\\AppData\\Roaming\\xPacks\\qemu-riscv\\xpack-qemu-riscv-9.2.4-1</code>.
...
<ul>
<li><code>xpack-qemu-riscv-9.2.4-1-darwin-x64.tar.gz</code></li>
<li><code>xpack-qemu-riscv-9.2.4-1-darwin-arm64.tar.gz</code></li>
</ul>
...
example <code>/Users/ilg/Library/xPacks/qemu-riscv/xpack-qemu-riscv-9.2.4-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/Library/xPacks/qemu-riscv
cd ~/Library/xPacks/qemu-riscv

tar xvf ~/Downloads/xpack-qemu-riscv-9.2.4-1-darwin-x64.tar.gz
chmod -R -w xpack-qemu-riscv-9.2.4-1
`} </CodeBlock>
...
<ul>
<li><code>xpack-qemu-riscv-9.2.4-1-linux-x64.tar.gz</code></li>
<li><code>xpack-qemu-riscv-9.2.4-1-linux-arm64.tar.gz</code></li>
</ul>
...
example <code>/home/ilg/.local/xPacks/qemu-riscv/xpack-qemu-riscv-9.2.4-1</code>:

<CodeBlock language="console"> {
`mkdir -p ~/.local/xPacks/qemu-riscv
cd ~/.local/xPacks/qemu-riscv

tar xvf ~/Downloads/xpack-qemu-riscv-9.2.4-1-linux-x64.tar.gz
chmod -R -w xpack-qemu-riscv-9.2.4-1
`} </CodeBlock>
