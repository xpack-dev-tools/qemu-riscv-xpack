...
file; the format is `2.8.0-13`. The fourth number is the xPack release number
...
and fix them; assign them to a milestone (like `2.8.0-13`).
...
named like **xPack QEMU RISC-V v2.8.0-13** (mind the dash),
...
- commit the `develop` branch of `xpack/web-jekyll` GitHub repo;
  use a message like **xPack QEMU RISC-V v2.8.0-13 released**
- push to GitHub
...
- commit all changes, use a message like
  `package.json: update urls for 2.8.0-13.1 release` (without `v`)
...
- `npm version 2.8.0-13.1`; the first 5 numbers are the same as the
...
- `npm dist-tag add @xpack-dev-tools/qemu-riscv@2.8.0-13.1 latest`
- `npm dist-tag ls @xpack-dev-tools/qemu-riscv`

In case the previous version is not functional and needs to be unpublished:

- `npm unpublish @xpack-dev-tools/qemu-riscv@2.8.0-13.X`
...
- paste the release name like **xPack QEMU RISC-V v2.8.0-13 released**
