...
[![NPM Version](https://img.shields.io/npm/v/@xpack-dev-tools/qemu-riscv?color=blue)](https://www.npmjs.com/package/@xpack-dev-tools/qemu-riscv/)
...
distribution of QEMU RISC-V,
intended for reproducible builds.

## Project documentation

For information on how to install and use this project, please refer to the
[project website](https://xpack-dev-tools.github.io/qemu-riscv-xpack/).

## Project source

The source code of the current release is available on
GitHub as [xpack-dev-tools/qemu-riscv-xpack](https://github.com/xpack-dev-tools/qemu-riscv-xpack),
the [v9.2.4-1.1](https://github.com/xpack-dev-tools/qemu-riscv-xpack/tree/v9.2.4-1.1) tree.
