...
function application_build_versioned_components()
{
  ...
  # ---------------------------------------------------------------------------
  if [[ "${XBB_RELEASE_VERSION}" =~ 9[.]2[.][0-9]*-[0-9]* ]]
  then
    # -------------------------------------------------------------------------
    ...
    then
      ...
      sdl2_build "2.32.10" # "2.30.1"
      # https://www.libsdl.org/projects/SDL_image/release/
      sdl2_image_build "2.8.8" # "2.8.2"
    fi
    ...
    libunistring_build "1.4" # "1.2"

    # required by glib
    # https://ftp.gnu.org/pub/gnu/gettext/
    gettext_build "0.26" # "0.22"
  ...
  elif [[ "${XBB_RELEASE_VERSION}" =~ 8[.]2[.][0-9]*-[0-9]* ]]
  then
    # -------------------------------------------------------------------------
    # Build the native dependencies.
    ...
    # https://sourceforge.net/projects/libpng/files/libpng16/
    libpng_build "1.6.43" # "1.6.40"

    # https://www.ijg.org/files/
    jpeg_build "9f" # "9e"

    # https://gitlab.gnome.org/GNOME/libxml2/-/releases
    libxml2_build "2.12.6" # "2.11.5"
    ...
    then
      ...
      # https://www.libsdl.org/release/
      sdl2_build "2.30.1" # "2.28.3"
      # https://www.libsdl.org/projects/SDL_image/release/
      sdl2_image_build "2.8.2" # "2.6.3"
    fi
